#ifndef __c1_buck_interval_flatten_h__
#define __c1_buck_interval_flatten_h__
...
/* Type Definitions */
#ifndef typedef_SFc1_buck_interval_flattenInstanceStruct
#define typedef_SFc1_buck_interval_flattenInstanceStruct
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_buck_interval_flatten;
  uint8_T c1_is_c1_buck_interval_flatten;
  real_T c1_VcH;
...
#endif                                 /*typedef_SFc1_buck_interval_flattenInstanceStruct*/
...
extern void c1_buck_interval_flatten_method_dispatcher(SimStruct *S, int_T
  method, void *data);
