...
#
#  $RCSfile: buck_interval_flatten.mk $ $Revision: 2.74 $ $Date: 2014/02/25 16:00:13MEZ $
...
MAKEFILE                       = buck_interval_flatten.mk
...
COMPUTER                       = PCWIN64
MODEL                          = buck_interval_flatten
MODULES                        = buck_interval_flatten_data.c buck_interval_flatten_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	$(START_DIR)\buck_interval_flatten_rti1103 \
	$(START_DIR)
