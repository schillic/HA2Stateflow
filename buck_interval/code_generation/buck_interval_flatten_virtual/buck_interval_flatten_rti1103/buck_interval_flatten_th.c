/************************ dSPACE target specific file *************************
   ...
   Include file .\buck_interval_flatten_rti1103\buck_interval_flatten_th.c :

   Task Configuration file for model : buck_interval_flatten

   RTI1103 7.2 (02-May-2014)/2.5
   13-Jan-2016 19:02:02
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\buck_interval_flatten_rti1103\buck_interval_flatten_th.c is for ST).
# endif
