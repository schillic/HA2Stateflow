...
#include <stddef.h>
#include "blas.h"
#include "buck_interval_flatten_actual_sfun.h"
#include "c1_buck_interval_flatten_actual.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "buck_interval_flatten_actual_sfun_debug_macros.h"
...
static void initialize_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void initialize_params_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void enable_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void disable_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void set_sim_state_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void c1_set_sim_state_side_effects_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void finalize_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void sf_gateway_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void zeroCrossings_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void derivatives_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void outputs_c1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void initSimStructsc1_buck_interval_flatten_actual
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void c1_eml_ini_fcn_to_be_inlined_338
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void c1_eml_term_fcn_to_be_inlined_338
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_emlrt_marshallOut
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const real_T
   c1_u);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const mxArray
   *c1_nargout, const char_T *c1_identifier);
...
static const mxArray *c1_b_emlrt_marshallOut
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const
   boolean_T c1_u);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static boolean_T c1_c_emlrt_marshallIn
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const mxArray
   *c1_sf_internal_predicateOutput, const char_T *c1_identifier);
...
static const mxArray *c1_c_emlrt_marshallOut
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const int32_T
   c1_u);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_e_emlrt_marshallIn
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const mxArray
   *c1_b_sfEvent, const char_T *c1_identifier);
...
static const mxArray *c1_d_emlrt_marshallOut
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const uint8_T
   c1_u);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint8_T c1_g_emlrt_marshallIn
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, const mxArray
   *c1_b_tp_charging_charging_controller, const char_T *c1_identifier);
...
static void c1_updateDataWrittenToVector
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance, uint32_T
   c1_vectorIndex);
  ...
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_buck_interval_flatten_actual = 0U;
  chartInstance->c1_is_c1_buck_interval_flatten_actual = c1_IN_NO_ACTIVE_CHILD;
  ...
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance)
{
  ...
  if (chartInstance->c1_is_active_c1_buck_interval_flatten_actual == 1U) {
    _SFD_CC_CALL(CHART_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
  }

  if (chartInstance->c1_is_c1_buck_interval_flatten_actual ==
   ...
   *c1_st)
{
  ...
  c1_update_debugger_state_c1_buck_interval_flatten_actual(chartInstance);
  ...
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance)
{
  ...
  c1_Vo = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  ...
  c1_set_sim_state_side_effects_c1_buck_interval_flatten_actual(chartInstance);
  ...
  if (ssIsMajorTimeStep(chartInstance->S) != 0) {
    ...
    _SFD_DATA_RANGE_CHECK(*c1_Vo, 36U);
    chartInstance->c1_sfEvent = CALL_EVENT;
    _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
    if (chartInstance->c1_is_active_c1_buck_interval_flatten_actual == 0U) {
      _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
      chartInstance->c1_stateChanged = true;
      chartInstance->c1_is_active_c1_buck_interval_flatten_actual = 1U;
      ...
      *c1_mode_out = 1.0;
      ...
      chartInstance->c1_stateChanged = true;
      chartInstance->c1_is_c1_buck_interval_flatten_actual =
        c1_IN_charging_charging_controller;
      _SFD_CS_CALL(STATE_ACTIVE_TAG, 0U, chartInstance->c1_sfEvent);
      chartInstance->c1_tp_charging_charging_controller = 1U;
    } else {
      switch (chartInstance->c1_is_c1_buck_interval_flatten_actual) {
       case c1_IN_charging_charging_controller:
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_out, 2U, c1_b_sf_marshallOut,
          c1_b_sf_marshallIn);
        c1_out = CV_EML_IF(1, 0, 0, *c1_Vo >= c1_const_VcH);
        _SFD_SYMBOL_SCOPE_POP();
        if (c1_out) {
       ...
       case c1_IN_dcm_discharging_controller:
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_b_out, 2U, c1_b_sf_marshallOut,
          c1_b_sf_marshallIn);
        c1_b_out = CV_EML_IF(4, 0, 0, *c1_Vo <= c1_const_VcL);
        _SFD_SYMBOL_SCOPE_POP();
        if (c1_b_out) {
       ...
       case c1_IN_discharging_discharging_controller:
        ...
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_c_out, 2U, c1_b_sf_marshallOut,
          c1_b_sf_marshallIn);
        c1_c_out = CV_EML_IF(2, 0, 0, *c1_Vo <= c1_const_VcL);
        _SFD_SYMBOL_SCOPE_POP();
        if (c1_c_out) {
          ...
          *c1_mode_out = 1.0;
          ...
          if (CV_EML_COND(3, 0, 0, *c1_il <= 0.0)) {
            if (CV_EML_COND(3, 0, 1, *c1_Vo > c1_const_VcL)) {
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_buck_interval_flatten_actualMachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance;
  chartInstance = (SFc1_buck_interval_flatten_actualInstanceStruct *)
    chartInstanceVoid;
  ...
  (SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance)
{
  ...
  sf_mex_setcell(c1_y, 9, c1_d_emlrt_marshallOut(chartInstance,
    chartInstance->c1_is_active_c1_buck_interval_flatten_actual));
   ...
   *c1_u)
{
  ...
  *c1_vc = c1_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 8)),
    "vc");
  chartInstance->c1_is_active_c1_buck_interval_flatten_actual =
    c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 9)),
    "is_active_c1_buck_interval_flatten_actual");
  chartInstance->c1_is_c1_buck_interval_flatten_actual = c1_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 10)),
     "is_c1_buck_interval_flatten_actual");
...
void sf_c1_buck_interval_flatten_actual_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3372674566U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(121694582U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3045051164U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(699650840U);
}

mxArray *sf_c1_buck_interval_flatten_actual_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("4e0wAvQh7S7iJDp0W4WQdC");
...
mxArray *sf_c1_buck_interval_flatten_actual_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_buck_interval_flatten_actual_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_buck_interval_flatten_actual(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[19],T\"buck_dcm_vs2_interval_sys_1_location\",},{M[1],M[1],T\"il_out\",},{M[1],M[7],T\"mode_out_out\",},{M[1],M[3],T\"t_out\",},{M[1],M[5],T\"vc_out\",},{M[5],M[2],T\"il\",},{M[5],M[8],T\"mode_out\",},{M[5],M[4],T\"t\",},{M[5],M[6],T\"vc\",},{M[8],M[0],T\"is_active_c1_buck_interval_flatten_actual\",}}",
    "100 S'type','srcId','name','auxInfo'{{M[9],M[0],T\"is_c1_buck_interval_flatten_actual\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 11, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_buck_interval_flatten_actual_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _buck_interval_flatten_actualMachineNumber_,
           1,
           3,
           5,
           0,
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(36,1,1,0,"Vo");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(36U, c1_Vo);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _buck_interval_flatten_actualMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "71t1D13V0tnOIg6Nco63m";
}

static void sf_opaque_initialize_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_buck_interval_flatten_actualInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
  initialize_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  enable_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  disable_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_zeroCrossings_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  zeroCrossings_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_outputs_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  outputs_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_derivatives_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  derivatives_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  sf_gateway_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_buck_interval_flatten_actual
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_buck_interval_flatten_actual();/* state var info */
...
extern void sf_internal_set_sim_state_c1_buck_interval_flatten_actual(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c1_buck_interval_flatten_actual();/* state var info */
  ...
  set_sim_state_c1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_buck_interval_flatten_actual
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_buck_interval_flatten_actual(S);
}

static void sf_opaque_set_sim_state_c1_buck_interval_flatten_actual(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_buck_interval_flatten_actual(S, st);
}

static void sf_opaque_terminate_c1_buck_interval_flatten_actual(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_buck_interval_flatten_actualInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_buck_interval_flatten_actual_optimization_info();
    }

    finalize_c1_buck_interval_flatten_actual
      ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_buck_interval_flatten_actual
    ((SFc1_buck_interval_flatten_actualInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_buck_interval_flatten_actual(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_buck_interval_flatten_actual(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_buck_interval_flatten_actual_optimization_info();
  ...
  ssSetChecksum0(S,(3169728840U));
  ssSetChecksum1(S,(2730804309U));
  ssSetChecksum2(S,(2692921954U));
  ssSetChecksum3(S,(1967623616U));
  ssSetNumContStates(S,4);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_buck_interval_flatten_actual(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_buck_interval_flatten_actual(SimStruct *S)
{
  SFc1_buck_interval_flatten_actualInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc1_buck_interval_flatten_actualInstanceStruct *)utMalloc
    (sizeof(SFc1_buck_interval_flatten_actualInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.zeroCrossings =
    sf_opaque_zeroCrossings_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.outputs =
    sf_opaque_outputs_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.derivatives =
    sf_opaque_derivatives_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_buck_interval_flatten_actual;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_buck_interval_flatten_actual;
...
void c1_buck_interval_flatten_actual_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_buck_interval_flatten_actual(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_buck_interval_flatten_actual(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_buck_interval_flatten_actual(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_buck_interval_flatten_actual_method_dispatcher.\n"
