/************************ dSPACE target specific file *************************
   ...
   Include file .\buck_interval_flatten_actual_rti1103\buck_interval_flatten_actual_th.c :

   Task Configuration file for model : buck_interval_flatten_actual

   RTI1103 7.2 (02-May-2014)/2.5
   13-Jan-2016 19:17:16
...
/* ===== List of model tasks and assigned interrupt sources ================
   ...
   Timer Task 1 [2e-05 0] s       : Timer A interrupt
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\buck_interval_flatten_actual_rti1103\buck_interval_flatten_actual_th.c is for ST).
# endif
...
/* Initialize dynamically generated services */
  ...
  rtith_bind_interrupt( /* --- Bind interrupt to task. ----- */
      ...
      pTask1,             /*  Task (TCB pointer).              */
      (2e-05 * RTI_TIMER_TASK_TIME_SCALE),             /*  Sample time or period.           */
      C_LOCAL,             /*  RTK channel.                     */
